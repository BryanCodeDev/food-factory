      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Una experiencia de sabor que comienza en la parrilla.
            </p>
            <div className="flex gap-4 mt-6">
              {socials.map((social) => (
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-gold/20 transition-colors">
          ...
          <div>
            <h4 className="font-heading font-semibold text-white mb-4">Marca</h4>
          ...
          <div>
            <h4 className="font-heading font-semibold text-white mb-4">Menú</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gold/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} Food Factory Parrilla. Todos los derechos reservados.
          </p>
